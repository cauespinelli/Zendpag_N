 ...
 * (merchants), pagamentos e um saque PENDING, para as telas de Estabelecimentos,
 * Transações e Saques do Painel Admin não aparecerem vazias.
 *
 * Só no perfil "dev". Idempotente (checa um referenceId de pagamento conhecido).
 * Tudo em um seeder usando as referências em memória — evita duplicar merchant
 * entre seeders.
 */
@Slf4j
@Component
...
public class DevDataSeeder implements CommandLineRunner {
    ...
    private void seed() {
        ...
        // 1) Estabelecimentos
        Merchant aurora = merchant("Loja Aurora Digital", "12345678000190", "financeiro@auroradigital.com.br");
        Merchant edu = merchant("EduMaster Cursos", "98765432000121", "contato@edumaster.com.br");
        Merchant fit = merchant("FitShop Suplementos", "45612378000155", "adm@fitshop.com.br");
        Merchant gamer = merchant("GamerZone Store", "11222333000144", "suporte@gamerzone.com.br");
        ...
        pay("PAY-SEED-0005", gamer, "Juliana Castro", "65498732100", "89.90", "0.90", PaymentStatus.APPROVED);
        ...
        pay("PAY-SEED-0008", gamer, "Beatriz Nunes", "74185296300", "899.00", "0.00", PaymentStatus.FAILED);

        // 3) Saque PENDING de teste (usa o merchant Aurora já criado, em memória)
        ...
        PixWithdrawal w = new PixWithdrawal("WD-SEED-0001", account, aurora,
        ...
        log.warn("[DevDataSeeder] Dados de teste criados: 4 estabelecimentos, 8 pagamentos e 1 saque PENDING (WD-SEED-0001).");
    }

    private Merchant merchant(String name, String document, String email) {
